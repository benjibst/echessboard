...
#
# Script generated by Vivado on Fri May 30 17:58:30 CEST 2025
...
# script info
echo -e "instr_mem.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L secureip -L xpm --snapshot instr_mem xil_defaultlib.instr_mem -log elaborate.log
}
