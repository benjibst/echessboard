...
#
# Script generated by Vivado on Thu Jul 10 16:15:04 CEST 2025
...
# script info
echo -e "instr_mem.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --debug typical --relax --mt 8  -L xil_defaultlib -L secureip -L xpm --snapshot instr_mem xil_defaultlib.instr_mem -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim instr_mem -key {Behavioral:sim_2:Functional:instr_mem} -tclbatch cmd.tcl -log simulate.log
}
