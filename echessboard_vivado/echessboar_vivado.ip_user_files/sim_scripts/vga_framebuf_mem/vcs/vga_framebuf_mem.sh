...
#
# Script generated by Vivado on Thu Jun 19 15:47:19 CEST 2025
# SW Build 6140274 on Wed May 21 22:58:25 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : vga_framebuf_mem.sh
...
#
# Usage        : vga_framebuf_mem.sh
#                vga_framebuf_mem.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                vga_framebuf_mem.sh [-reset_run]
#                vga_framebuf_mem.sh [-reset_log]
#                vga_framebuf_mem.sh [-help]
#
...
#                script (type 'vga_framebuf_mem.sh -help' for more information).
#
...
# script info
echo -e "vga_framebuf_mem.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./vga_framebuf_mem.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../../../../Xillinx/2025.1/data/rsb/busdef" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.vga_framebuf_mem xil_defaultlib.glbl -o vga_framebuf_mem_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./vga_framebuf_mem_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/benni/dev/echessboard/echessboard_vivado/echessboar_vivado.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key vga_framebuf_mem_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc vga_framebuf_mem_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./vga_framebuf_mem.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: vga_framebuf_mem.sh [-help]\n\
Usage: vga_framebuf_mem.sh [-step]\n\
Usage: vga_framebuf_mem.sh [-lib_map_path]\n\
Usage: vga_framebuf_mem.sh [-reset_run]\n\
Usage: vga_framebuf_mem.sh [-reset_log]\n\
Usage: vga_framebuf_mem.sh [-keep_index]\n\
Usage: vga_framebuf_mem.sh [-noclean_files]\n\n\
