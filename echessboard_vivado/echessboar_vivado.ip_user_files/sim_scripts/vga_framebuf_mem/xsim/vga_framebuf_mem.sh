...
#
# Script generated by Vivado on Sat Jul 12 15:30:05 +0200 2025
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L secureip -L xpm --snapshot vga_framebuf_mem xil_defaultlib.vga_framebuf_mem -log elaborate.log
}
