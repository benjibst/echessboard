...
elaborate()
{
  xelab --debug typical --relax --mt 8  -L xil_defaultlib -L secureip -L xpm --snapshot vga_framebuf_mem xil_defaultlib.vga_framebuf_mem -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim vga_framebuf_mem -key {Behavioral:sim_2:Functional:vga_framebuf_mem} -tclbatch cmd.tcl -log simulate.log
}
