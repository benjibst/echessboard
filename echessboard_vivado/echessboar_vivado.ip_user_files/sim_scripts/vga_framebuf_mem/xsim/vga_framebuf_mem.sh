...
export RDI_DATADIR="/home/benni/Xillinx/Vivado/2024.2/data"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L secureip -L xpm --snapshot vga_framebuf_mem xil_defaultlib.vga_framebuf_mem -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim vga_framebuf_mem -key {Behavioral:sim_1:Functional:vga_framebuf_mem} -tclbatch cmd.tcl -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/benni/Xillinx/Vivado/2024.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb vga_framebuf_mem.wdb xsim.dir libdpi.so)
