...
#
# Script generated by Vivado on Fri May 30 18:06:20 CEST 2025
...
# script info
echo -e "register_file.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L secureip -L xpm --snapshot register_file xil_defaultlib.register_file -log elaborate.log
}
