...
HD_PWD='/home/benni/dev/echessboard/echessboard_vivado/echessboar_vivado.runs/vga_framebuf_mem_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_framebuf_mem.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vga_framebuf_mem.tcl
