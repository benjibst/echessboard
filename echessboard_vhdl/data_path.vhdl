...
begin
  ...
  writeback_stage: entity work.WritebackStage
    port map (
      wb_clk                => '0',         --dp_clk100,
      wb_class              => op_alu,      --op_class,
      wb_branch_cond        => '0',         --branch_cond,
      wb_mem_op_sz          => sz_byte,     --mem_op_sz,
      wb_mem_op_signed      => '0',         --mem_op_signed,
      wb_next_pc            => x"00000000", --next_pc_se,
      wb_alu_result         => x"00000000", --alu_result,
      wb_alu_result_pre     => x"00000000", --alu_result_pre,
      wb_rs2_val            => x"00000000", --reg_rs2_val,
      wb_stage              => ex_reset,    --stage,
      ...
      wb_pc_out             => open,        --pc_out,
      wb_rd_val             => open,        --rd_val,
